...
data class DatabaseSettingsMariaDB(
    ...
    override fun url(rootDir: File?): String = "jdbc:mariadb://${host}:${port}/${database}"
    override fun driver(): String = "org.mariadb.jdbc.Driver"
